...
<table width="595" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> </tr>
  <tr>
    <td align="left" class="cart-txt" style="font-size:12px">
  ...
  <tr bgcolor="#FFFFFF">
    <td><table width="100%">
      <tr align="center" bgcolor="#F3F1D1" class="table_txt" >
        ...
        <td width="7%" height="21" align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:12px">
         <?php 
      ...
      <tr  bgcolor="#FFFFFF" align="center" class="table_txt" >
        ...
        <td width="7%" height="21" align="left" valign="middle" style="font-size:12px">
         <?php		 
      ...
      <tr  bgcolor="#F3F1D1" align="center" class="table_txt" >
        ...
        <td width="7%" height="21" align="left" valign="top" bgcolor="#FFFFFF" style="font-size:12px">
          <?php
